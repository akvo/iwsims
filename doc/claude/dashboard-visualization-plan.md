...
### Construction Overview Tab

| Metric | Query |
|--------|-------|
| Total EPS Under Construction | COUNT(UNIQUE 1749624452994 WHERE 1749630516826 == 'No') |
| Overdue Projects | COUNT(UNIQUE 1749624452994 WHERE 1749630516825 < TODAY()) |

### Project Progress Calculation

**Denominator**: Sum of project scope items selected in 1749624505915
...
| Drainage | — | *Pending definition* |
| Site Security & Perimeter | 1849635500001 | 33% per item selected; 100% if all 3 selected |

**Overall Progress**: Average of all enabled components

### Completion Timeline

**Visualization**: Histogram with proposed completion date (1749630516825) and TODAY() reference line

**Filter**: Only EPS not yet completed (1749630516826 == 'Yes')

### Escalation List

**Inclusion Criteria**: Incomplete projects (1749630516826 == 'No') AND overdue (1749630516825 < TODAY())

**Table Columns**:
| Column | Source |
|--------|--------|
| EPS Name | 1749624452994 |
| Last Monitoring | Date field |
| Component Progress | See progress calculation |
| Overall Progress | Average of components |
| Expected Progress | (Days elapsed ÷ Total planned days) × 100% |
| Deadline | 1749630516825 |
